...
export const items: Record<ItemId, ItemDefinition> = {
  ...
  coal_ore: { id: 'coal_ore', name: 'Coal Ore', type: 'resource', rarity: 'uncommon', iconText: 'CL', color: '#1f2937', description: 'Dense fuel needed for steel and hardened arrowheads.', sellValue: 10, stackable: true, category: 'ore' },
  ...
  longbow: { id: 'longbow', name: 'Longbow', type: 'equipment', rarity: 'uncommon', iconText: 'LB', color: '#84cc16', description: 'A stronger ranged weapon shaped from flexible willow.', sellValue: 125, stackable: false, category: 'weapon', equipment: { slot: 'weapon', stats: { ranged: 11, maxHit: 4, intervalReduction: 160 }, levelRequirements: { ranged: 9 } } },
